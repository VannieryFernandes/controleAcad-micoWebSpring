    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Adicionar Novo Curso</h1>
	      <div class="modal-body">
	      <div class="form-group">
	      
	      
	        <form class="form-group" action="CursoSalvarServlet" method="get">		
				Nome do Curso: <input type="text" class="form-control" name="nome_curso"> <br>
				Tipo do Curso: <input type="text" class="form-control" name="tipo_curso"> <br>
