        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
	      ...
	      <div class="form-group">
	        ...
	        <form class="form-group" action="ProfessorSalvarServlet" method="post">		
				...
				Area de Atuação do Professor: <input type="text" class="form-control" name="areaAtuacao_professor"> <br>
				Titulação do Professor: <input type="text" class="form-control" name="titulacao_professor"> <br>
